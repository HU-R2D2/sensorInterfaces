...
namespace r2d2 {
    ...
    {    
        ...
        Clock::Duration echoTimeout = Clock::Duration(std::chrono::duration<long, std::micro>(5 * 1000 * 10)); // TODO: Define in UltrasonicSensor.hpp
        ...
        // r2d2::Length distance = ((travelTime * 1000 * 1000) * speedOfSound) / 2;
